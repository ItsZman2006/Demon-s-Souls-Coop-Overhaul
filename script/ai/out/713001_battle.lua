...
--	パラメータ3　なし
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_KajiSekichu_713001_Battle, "kajiSekichu_713001Battle");

-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_KajiSekichu_713001_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function kajiSekichu_713001Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
local Kougeki_Dist = 0.8					--攻撃の適正間合い
	...
	if fate <= 60 then
		...
		kajiSekichu_713001Battle_Kougeki(ai, goal)
		kajiSekichu_713001Battle_Kougeki_Noato(ai, goal)	
...
--  攻撃
---------------------------------------------------------
function kajiSekichu_713001Battle_Kougeki(ai, goal)
...
--  攻撃後の行動
---------------------------------------------------------
function kajiSekichu_713001Battle_Kougeki_Noato(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function kajiSekichu_713001Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function kajiSekichu_713001Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function kajiSekichu_713001Battle_Interupt(ai, goal)
