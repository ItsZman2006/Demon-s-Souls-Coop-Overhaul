...
--	パラメータ3　なし
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_NpcKISI_B802000_Battle, "npcKISI_B802000Battle");

--local c802000_NormalR_Dist = 2.5			--右手攻撃の適正間合い
--local c802000_farDist = 15.0				--遠いと判断する距離
--local c802000_nearDist = 4.0				--近いと判断する距離

-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_NpcKISI_B802000_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function npcKISI_B802000Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
--  右手コンボ
---------------------------------------------------------
function npcKISI_B802000Battle_NormalR_Comb(ai, goal)
...
--  攻撃後の行動
---------------------------------------------------------
function npcKISI_B802000Battle_Kougeki_Noato(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function npcKISI_B802000Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function npcKISI_B802000Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function npcKISI_B802000Battle_Interupt(ai, goal)
