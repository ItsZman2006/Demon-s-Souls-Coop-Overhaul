...
--	説明：
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_Ryosyu207002_Battle, "Ryosyu207002Battle");


-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_Ryosyu207002_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function Ryosyu207002Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
	...
	--間合い以内なら
		--攻撃する
		--攻撃後行動
		Ryosyu207002Battle_Attack(ai, goal)
		Ryosyu207002Battle_AfterAttack(ai, goal)
	end
end
...
--  攻撃
---------------------------------------------------------
function Ryosyu207002Battle_Attack(ai, goal)
...
--  攻撃後の行動
---------------------------------------------------------
function Ryosyu207002Battle_AfterAttack(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function Ryosyu207002Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function Ryosyu207002Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function Ryosyu207002Battle_Interupt(ai, goal)
