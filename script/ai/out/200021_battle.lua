...
--	パラメータ3　なし
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_Kisi200021_Battle, "kisi200021Battle");


-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_Kisi200021_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function kisi200021Battle_Activate(ai, goal)
-------------------------------------------------------------------------------

local targetDist = ai:GetDist(TARGET_ENE_0);			--敵ターゲットとの距離を取得
local NormalR_Dist = 2.0						--攻撃の間合い
...
--	else
		if fate <= 20 then
			goal:AddSubGoal(GOAL_COMMON_ApproachTarget, 10.0, TARGET_ENE_0, NormalR_Dist, TARGET_ENE_0, true, 9910 );
			goal:AddSubGoal(GOAL_COMMON_ComboAttack, 10.0, 3000, TARGET_ENE_0, DIST_Middle, 0);
			kisi200021Battle_Kougeki_Noato(ai, goal)
		elseif fate <= 80 then
			goal:AddSubGoal(GOAL_COMMON_SidewayMove, 4.0, TARGET_ENE_0, ai:GetRandam_Int(0,1), ai:GetRandam_Int(10,25), true, true ,9910 );
		else
			goal:AddSubGoal(GOAL_COMMON_LeaveTarget, 2.0, TARGET_ENE_0, BackDist, TARGET_ENE_0, true, 9910 );
			goal:AddSubGoal(GOAL_COMMON_SidewayMove, 3.0, TARGET_ENE_0, ai:GetRandam_Int(0,1), ai:GetRandam_Int(10,25), true, true ,9910 );
		end
--	end
...
--		kisi200021Battle_Kougeki(ai, goal)
...
--  攻撃
---------------------------------------------------------
function kisi200021Battle_Kougeki(ai, goal)
...
--  攻撃後の行動
---------------------------------------------------------
function kisi200021Battle_Kougeki_Noato(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function kisi200021Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function kisi200021Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function kisi200021Battle_Interupt(ai, goal)
...
--		if kisi200021Battle_Enkyori(ai, goal ) == true then
--		return true
--		end
--	end
...
--  遠距離対応
---------------------------------------------------------
function kisi200021Battle_Enkyori(ai, goal )
