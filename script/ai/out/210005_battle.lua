...
--	説明：祈る（虜囚から）
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_Huhai210005_Battle, "Huhai210005Battle");


-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_Huhai210005_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function Huhai210005Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
	...
	if( targetDist <= ai:GetDistParam( DIST_Near ) ) then
			...
			-- たまにお祈り
			if( fate2 <= 100 ) then
				goal:AddSubGoal( GOAL_COMMON_Attack, 7, 3301, TARGET_EVENT,DIST_None, 0 )
...
--  ゴール更新
---------------------------------------------------------
function Huhai210005Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function Huhai210005Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function Huhai210005Battle_Interupt(ai, goal)
	...
	if( ai:IsInterupt( INTERUPT_FindAttack ) ) then
		...
		if( targetDist <= 2 ) then
			goal:ClearSubGoal();
			goal:AddSubGoal( GOAL_COMMON_Attack, 7, 3301, TARGET_ENE_0, DIST_Near, 0 )
		end
	end
