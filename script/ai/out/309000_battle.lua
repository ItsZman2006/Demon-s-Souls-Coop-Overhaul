...
local maaiDist = 1.8		--UŒ‚‚Ì‚½‚ß‚É‹ß‚Ã‚­‹——£@š”Ä—p‰»‚Ìˆ×AUŒ‚‚²‚Æ‚É•ª‚¯‚¸š
	...
	--ŠÔ‡‚¢ˆÈ“à‚È‚ç
		--UŒ‚‚·‚é
		--UŒ‚Œãs“®
		Ooka309000Battle_Kougeki(ai, goal)
		Ooka309000Battle_Kougeki_Noato(ai, goal)
	end
end
...
--  UŒ‚
---------------------------------------------------------
function Ooka309000Battle_Kougeki(ai, goal)
...
--  UŒ‚Œã‚Ìs“®
---------------------------------------------------------
function Ooka309000Battle_Kougeki_Noato(ai, goal)
