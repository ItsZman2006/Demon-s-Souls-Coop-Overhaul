...
--	パラメータ3　なし
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_Wizard800000_Battle, "Wizard800000Battle");

-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_Wizard800000_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function Wizard800000Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
local NormalR_Dist = 2.5			--右手攻撃の適正間合い
	...
	if targetDist >= farDist then
		--ファンネル魔法を使う
			...
			Wizard800000Battle_NormalR_Comb(ai, goal)
			Wizard800000Battle_Kougeki_Noato(ai, goal)
...
--  右手コンボ
---------------------------------------------------------
function Wizard800000Battle_NormalR_Comb(ai, goal)
...
--  攻撃後の行動
---------------------------------------------------------
function Wizard800000Battle_Kougeki_Noato(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function Wizard800000Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function Wizard800000Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function Wizard800000Battle_Interupt(ai, goal)
