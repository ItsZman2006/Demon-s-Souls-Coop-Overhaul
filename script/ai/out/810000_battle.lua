...
--	パラメータ3　なし
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_pachi810000_Battle, "pachi810000Battle");

-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_pachi810000_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function pachi810000Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
local NormalR_Dist = 2.5					--右手攻撃の適正間合い
	...
	if targetDist >= NormalR_Dist then
		--基本戦闘（近い）
		pachi810000Battle_Normal_Near(ai, goal)
	--極端に近いなら
	else
		--基本戦闘（極端に近い）
		pachi810000Battle_Normal_TooNear(ai, goal)
...
--  基本戦闘（極端に近い）
---------------------------------------------------------
function pachi810000Battle_Normal_TooNear(ai, goal)
...
local Attack_fate = 50 					--攻撃する確率
	...
	if fate <= Attack_fate then
		pachi810000Battle_NormalR_Comb(ai, goal)
		pachi810000Battle_Kougeki_Noato(ai, goal)
	--40% ガード
	else
		pachi810000Battle_Kougeki_Noato(ai, goal)
	end
...
--  基本戦闘（近い）
---------------------------------------------------------
function pachi810000Battle_Normal_Near(ai, goal)
...
--  右手コンボ
---------------------------------------------------------
function pachi810000Battle_NormalR_Comb(ai, goal)
...
--  攻撃後の行動
---------------------------------------------------------
function pachi810000Battle_Kougeki_Noato(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function pachi810000Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function pachi810000Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function pachi810000Battle_Interupt(ai, goal)
