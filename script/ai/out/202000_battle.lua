...
local Act08Per = 0		--回復を使う
	...
	elseif targetDist >= 8.0 then
		...
		--どちらでもなかったら	
			...
			Act01Per = 0		--ダッシュ接近＆ガード崩し
			Act02Per = 0		--歩行接近＆ガード崩し
			Act03Per = 50		--ダッシュ接近＆突進突き	
			Act04Per = 20		--ダッシュ接近＆近接攻撃
			Act05Per = 10		--歩行接近＆突進突き
			Act06Per = 5		--歩行接近＆溜め斬り
	...
	elseif targetDist >= 2.5 then	
		...
		if ai:IsTargetGuard( TARGET_ENE_0 ) then
			...
			Act03Per = 0		--ダッシュ接近＆突進突き	
			Act04Per = 0		--ダッシュ接近＆近接攻撃
			Act05Per = 45		--歩行接近＆突進突き
			Act06Per = 10		--歩行接近＆溜め斬り
			Act07Per = 45		--歩行接近＆近接攻撃
			Act08Per = 0		--回復を使う
