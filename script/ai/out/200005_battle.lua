...
--	パラメータ3　なし
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_DoreiTANKEN_B200005_Battle, "doreiTANKEN_B200005Battle");


-- Updateでなにもやっていないので、呼ばないようにする
REGISTER_GOAL_NO_UPDATE( GOAL_DoreiTANKEN_B200005_Battle, 1 );


---------------------------------------------------------
--  ゴール起動
---------------------------------------------------------
function doreiTANKEN_B200005Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
--			goal:AddSubGoal(GOAL_COMMON_SidewayMove, 5.0, TARGET_ENE_0, ai:GetRandam_Int(0,1), ai:GetRandam_Int(30,45), true, true ,9910 );
			...
			doreiTANKEN_B200005Battle_Kougeki(ai, goal)
			doreiTANKEN_B200005Battle_Kougeki_Noato(ai, goal)
--			if fate <= 80 then
...
--			if fate <= 50 then
--				goal:AddSubGoal(GOAL_COMMON_SidewayMove, 2.0, TARGET_ENE_0, ai:GetRandam_Int(0,1), ai:GetRandam_Int(30,45), true, true ,-1 );
				doreiTANKEN_B200005Battle_Kougeki(ai, goal)
				doreiTANKEN_B200005Battle_Kougeki_Noato(ai, goal)
--			else
...
--  攻撃
---------------------------------------------------------
function doreiTANKEN_B200005Battle_Kougeki(ai, goal)

local K_fate = ai:GetRandam_Int(1,100)			--確率判定で使用する運命の数字

	--60% 3000	--20% 3000-3001　--15% 3002　--5% 3000-3001-3002
	if K_fate < 60 then
...
--  攻撃後の行動
---------------------------------------------------------
function doreiTANKEN_B200005Battle_Kougeki_Noato(ai, goal)
...
--  ゴール更新
---------------------------------------------------------
function doreiTANKEN_B200005Battle_Update(ai, goal)
...
--  ゴール終了
---------------------------------------------------------
function doreiTANKEN_B200005Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function doreiTANKEN_B200005Battle_Interupt(ai, goal)
return false;
end
