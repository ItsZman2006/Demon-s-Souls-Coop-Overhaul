...
--	ƒpƒ‰ƒ[ƒ^3@‚È‚µ
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_Nezumi306000_Battle, "Nezumi306000Battle");


-- Update‚Å‚È‚É‚à‚â‚Á‚Ä‚¢‚È‚¢‚Ì‚ÅAŒÄ‚Î‚È‚¢‚æ‚¤‚É‚·‚é
REGISTER_GOAL_NO_UPDATE( GOAL_Nezumi306000_Battle, 1 );


---------------------------------------------------------
--  ƒS[ƒ‹‹N“®
---------------------------------------------------------
function Nezumi306000Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
local maaiDist = 1.8		--UŒ‚‚Ì‚½‚ß‚É‹ß‚Ã‚­‹——£@š”Ä—p‰»‚Ìˆ×AUŒ‚‚²‚Æ‚É•ª‚¯‚¸š
	...
	if ai:IsFinishTimer(0) == true then
		local firstTime = ai:GetRandam_Float(0.0, 5.0)			--Å‰‚Ì“®‚«o‚µ‚Ü‚Å‚ÌŠÔ
	...
	--ŠÔ‡‚¢ˆÈ“à‚È‚ç
		--UŒ‚‚·‚é
		--UŒ‚Œãs“®
		Nezumi306000Battle_Kougeki(ai, goal)
		Nezumi306000Battle_Kougeki_Noato(ai, goal)
	end
end
...
--  UŒ‚
---------------------------------------------------------
function Nezumi306000Battle_Kougeki(ai, goal)
...
--  UŒ‚Œã‚Ìs“®
---------------------------------------------------------
function Nezumi306000Battle_Kougeki_Noato(ai, goal)
...
--  ƒS[ƒ‹XV
---------------------------------------------------------
function Nezumi306000Battle_Update(ai, goal)
...
--  ƒS[ƒ‹I—¹
---------------------------------------------------------
function Nezumi306000Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function Nezumi306000Battle_Interupt(ai, goal)
