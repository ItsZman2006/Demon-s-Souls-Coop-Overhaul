...
--	ƒpƒ‰ƒ[ƒ^3@‚È‚µ
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_kuma313004_Battle, "kuma313004Battle");


-- Update‚Å‚È‚É‚à‚â‚Á‚Ä‚¢‚È‚¢‚Ì‚ÅAŒÄ‚Î‚È‚¢‚æ‚¤‚É‚·‚é
REGISTER_GOAL_NO_UPDATE( GOAL_kuma313004_Battle, 1 );


---------------------------------------------------------
--  ƒS[ƒ‹‹N“®
---------------------------------------------------------
function kuma313004Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
local maaiDist = 1.3		--UŒ‚‚Ì‚½‚ß‚É‹ß‚Ã‚­‹——£@š”Ä—p‰»‚Ìˆ×AUŒ‚‚²‚Æ‚É•ª‚¯‚¸š

	-- Å‰‚É‚¿‚å‚Á‚Æ‚¾‚¯‘Ò‚Â
	if ai:IsFinishTimer(0) == true then
		local firstTime = ai:GetRandam_Float(0.0, 0.5)			--Å‰‚Ì“®‚«o‚µ‚Ü‚Å‚ÌŠÔ
...
--~ 			goal:AddSubGoal(GOAL_COMMON_Attack, 5.0, 3000, TARGET_ENE_0, DIST_Near, 0);
	...
	--ŠÔ‡‚¢ˆÈ“à‚È‚ç
		--UŒ‚‚·‚é
		--UŒ‚Œãs“®
		kuma313004Battle_Kougeki(ai, goal)
		kuma313004Battle_Kougeki_Noato(ai, goal)
	end
end
...
--  UŒ‚
---------------------------------------------------------
function kuma313004Battle_Kougeki(ai, goal)
...
--  UŒ‚Œã‚Ìs“®
---------------------------------------------------------
function kuma313004Battle_Kougeki_Noato(ai, goal)
...
--  ƒS[ƒ‹XV
---------------------------------------------------------
function kuma313004Battle_Update(ai, goal)
...
--  ƒS[ƒ‹I—¹
---------------------------------------------------------
function kuma313004Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function kuma313004Battle_Interupt(ai, goal)
