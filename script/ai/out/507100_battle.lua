...
--	ƒpƒ‰ƒ[ƒ^3@‚È‚µ
-----------------------------------------------------------------------------------------------
REGISTER_GOAL(GOAL_Mukade507100_Battle, "Mukade507100Battle");


-- Update‚Å‚È‚É‚à‚â‚Á‚Ä‚¢‚È‚¢‚Ì‚ÅAŒÄ‚Î‚È‚¢‚æ‚¤‚É‚·‚é
REGISTER_GOAL_NO_UPDATE( GOAL_Mukade507100_Battle, 1 );


---------------------------------------------------------
--  ƒS[ƒ‹‹N“®
---------------------------------------------------------
function Mukade507100Battle_Activate(ai, goal)
-------------------------------------------------------------------------------
...
local nearDist = 3.5		--‹ß‚¢‚Æ”»’f‚·‚é‹——£
local maaiDist = 0.9		--UŒ‚‚Ì‚½‚ß‚É‹ß‚Ã‚­‹——£@š”Ä—p‰»‚Ìˆ×AUŒ‚‚²‚Æ‚É•ª‚¯‚¸š
	...
	--ŠÔ‡‚¢ˆÈ“à‚È‚ç
		--UŒ‚‚·‚é
		--UŒ‚Œãs“®
		Mukade507100Battle_Kougeki(ai, goal)
		Mukade507100Battle_Kougeki_Noato(ai, goal)
	end
end
...
--  UŒ‚
---------------------------------------------------------
function Mukade507100Battle_Kougeki(ai, goal)
...
--  UŒ‚Œã‚Ìs“®
---------------------------------------------------------
function Mukade507100Battle_Kougeki_Noato(ai, goal)

local KN_fate = ai:GetRandam_Int(1,100)			--Šm—¦”»’è‚Åg—p‚·‚é‰^–½‚Ì”š
local SideTime = 0.0							--‰¡‚É“®‚­ŠÔ
local BackDist = ai:GetRandam_Float(0.5, 1.0)	--Œã‘Ş‚·‚é‹——£
local BackTime = 1.0							--Œã‘Ş‚·‚éŠÔ
...
--  ƒS[ƒ‹XV
---------------------------------------------------------
function Mukade507100Battle_Update(ai, goal)
...
--  ƒS[ƒ‹I—¹
---------------------------------------------------------
function Mukade507100Battle_Terminate(ai, goal)
end
...
---------------------------------------------------------
function Mukade507100Battle_Interupt(ai, goal)
